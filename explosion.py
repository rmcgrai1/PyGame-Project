# Jacob Kassman and Ryan McGrail
# explosion.py
# Defines explosion class that plays when a player dies.
...
class Explosion(Drawable):
	def __init__(self, gameSpace, x, y, z):	
		...
		# Build numpy arrays for each frame
		self.spritePixels = []
